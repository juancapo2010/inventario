...
<div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
        ...
        <table border="0" id="table-data" width="80%">
            <tr>
                <td width="70px">SN</td>
                <td width="">: {{ $product_entrega->product->sn }}</td>
                <td width="30px">Creado</td>
                <td>: {{ $product_entrega->tanggal }}</td>
            </tr>

            <tr>
                <td>Telefono</td>
                <td>: {{ $product_entrega->asignable->telepon }}</td>
                <td>Sector</td>
                <td>: {{ $product_entrega->asignable->alamat }}</td>
            </tr>

            <tr>
                <td>Nombre</td>
                <td>: {{ $product_entrega->asignable->nama }}</td>
                <td>Email</td>
                <td>: {{ $product_entrega->asignable->email }}</td>
            </tr>

            <tr>
                <td>Producto</td>
                <td >: {{ $product_entrega->product->activo->name }}</td>
                <td>Nombre de Red</td>
                <td >: {{ $product_entrega->qty }}</td>
            </tr>
