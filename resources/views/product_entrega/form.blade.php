            ...
            <form  id="form-item" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data" >
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label >Estado</label>
                            {!! Form::select('estado_id', $estados, null, ['class' => 'form-control selectpicker select', 'data-show-subtext'=>'false' ,'data-live-search'=>'true', 'placeholder' => '-- Seleccione Estado --', 'id' => 'estado_id', 'required']) !!}
                            <span class="help-block with-errors"></span>
                        </div>
