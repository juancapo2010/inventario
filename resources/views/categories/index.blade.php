...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <a onclick="addForm()" class="btn btn-primary" >Agregar Categorias</a>
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <table id="categories-table" class="table table-striped responsive nowrap">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>Nombre</th>
...
@section('bot')
    ...
    <script type="text/javascript">
        ...
        function addForm() {
            ...
            $('.modal-title').text('Agregar Categorias');
        }
